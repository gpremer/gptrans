...
import net.premereur.gae.transport.service.restlet.TransportDemandsRestletServlet;
...
public class ServletModule extends com.google.inject.servlet.ServletModule {
	...
	private static final String TRANSPORT_QUOTE_URL_PATTERN = "/transport/quoteService/*";
	private static final String TRANSPORT_DEMANDS_URL_PATTERN = "/transport/demandService/*";
	...
	protected void configureServlets() {
		...
		serve(TRANSPORT_QUOTE_URL_PATTERN).with(QuoteRestletServlet.class);
		...
		serve(TRANSPORT_DEMANDS_URL_PATTERN).with(TransportDemandsRestletServlet.class);
	}
